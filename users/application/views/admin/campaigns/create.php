<div class="container">
    ...
    <div class="">
        <div class="col-lg-5 col-sm-5 well">
            ...
            echo form_open("admin/create_campaign", $attributes);
            ?>
            <div class="col-xs-12">
                        ...
                        <div class="col-lg-7 col-sm-7">
                            <select name="client" id="client" class="form-control">
                                ...
                                foreach ($clients as $client) { ?>
                                    <option value="<?= $client->id ?>"><?= $client->contact_first_name ?> <?= $client->contact_last_name ?></option>
                                    <?php
                                } ?>
                            </select>
...
//                                $the_marketplace_id = 'marketplace_' . $marketplace->id;
                ...
                <div class="form-group">
                    <div class="row colbox">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            <input class="form-control" id="start" name="start_date" type="date"/>
                ...
                <div class="form-group">
                    <div class="row colbox">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            <input class="form-control" id="end" name="end_date" type="date"/>
